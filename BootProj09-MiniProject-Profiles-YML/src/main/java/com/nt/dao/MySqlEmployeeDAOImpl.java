...
public class MySqlEmployeeDAOImpl implements IEmployeeDAO {
	private static final String GET_EMP_BY_DESG = "SELECT ENO,ENAME,DESG,SAL FROM EMP_PROFILE WHERE DESG IN(?,?,?)ORDER BY DESG";
@Autowired
	private DataSource ds;
	@Override
	public List<Employee>  getEmpsByDesg(String desg1, String desg2, String desg3) throws Exception {
		System.out.println("MySqlEmployeeDAOImpl.getEmpsByDesg()"+ds.getClass());
