...
@GetMapping("/add")
public String showAddEmployeeFrom(@ModelAttribute Employee emp ){
...
@PostMapping("/add")
public String addEmployee(RedirectAttributes attrs,@ModelAttribute Employee emp) {
	// use service
...
@GetMapping("/edit")
public String showEditEmployeeFrom(@RequestParam int no, @ModelAttribute Employee emp) {
...
@PostMapping("/edit")
public String editEmployee(@ModelAttribute Employee emp, RedirectAttributes attrs ) {
